import { Group, RankingItem, Rankings, Role } from '@/app/_common/types/group';
import ItemCardMenu from './ItemCardMenu';
import { Divider, Grid, Rating, TextField, Typography } from '@mui/material';
import { useMutation, useQuery } from '@apollo/client';
import { MY_GROUPS, RANKING_ITEMS } from '@/app/_common/graphql/queries';
import useCurrentGroupMember from '@/app/_common/hooks/useCurrentGroupMember';
import LoadingPage from '@/app/_common/components/Page/LoadingPage';
import { useEffect, useState } from 'react';
import {
  CREATE_RANKING,
  UPDATE_RANKING,
} from '@/app/_common/graphql/mutations';
